...
# - Locally: no DATABASE_URL set → uses SQLite (psycopg2 never called)
# - Vercel:  DATABASE_URL set → uses psycopg2-binary (works on Vercel Python 3.12)
#            psycopg2 natively understands ?sslmode=require in the URL
